...
The `nba_shots` data was scraped from the [NBA stats API](http://stats.nba.com/) and contains 81,383 basketball shots taken by five star NBA players. 
...
The `helper.R` code, as well as the code used to scrape the data, is adapted from [Todd Schneider's ballR app](https://github.com/toddwschneider/ballr). While the code looks complicated, it is just used to draw the lines of a basketball court. The empty basketball court (below) is a ggplot object you can put other ggplot layers on top of.
...
<iframe width="560" height="315" align="center" src="https://www.youtube.com/embed/KdVE-2OuScI" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
