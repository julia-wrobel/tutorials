...
This tutorial gives an introduction to using the Unix command line. I provide background slides here as well some basic commands, but the bulk of the coding will be done live. We'll be recording the tutorial as we go and that video will be posted as well. 
...
I named this tutorial "Using the OSX terminal" but really what we learn hear will allow you to interact with any OS within the family Unix operating systems.
